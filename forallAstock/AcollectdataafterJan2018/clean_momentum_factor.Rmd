...
row.names.momentum.3month <- colnames(original.price.data)[-c(1:3)]

row.names.momentum.6month <- colnames(original.price.data)[-c(1:6)]

row.names.momentum.12month <- colnames(original.price.data)[-c(1:12)]
