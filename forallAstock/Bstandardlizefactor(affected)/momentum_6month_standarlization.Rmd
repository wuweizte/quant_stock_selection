...
```{r}
monthly.momentum.6month <- read.csv("D:\\MyR\\quantprog\\Acollectdata\\monthly.momentum.6month.csv", 
...
write.csv(standardlized.monthly.momentum.6month, 
          "D:\\MyR\\quantprog\\Bstandardlizefactor\\standardlized.monthly.momentum.6month.csv")
