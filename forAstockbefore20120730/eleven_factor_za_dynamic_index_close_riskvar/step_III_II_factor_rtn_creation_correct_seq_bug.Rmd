...
```{r}
source("D:\\MyR\\quantprog\\forAstockbefore20140630\\eleven_factor_model_zf_close_riskvariance\\CreateFactorForecastCloseRiskVar.R")
...
# for(i in comparison.period:comparison.period){
        ...
        factor.forecast <- CreateFactorForecastCloseRiskVar(head(t.result.F.hat.g, index))
