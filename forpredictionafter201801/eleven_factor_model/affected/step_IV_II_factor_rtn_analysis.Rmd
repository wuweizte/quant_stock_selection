...
epttm.forecast <- ts(result.factor.forecast["epttm",], start = c(2017, 5), frequency = 12)
...
turnoverrate60.forecast <- ts(result.factor.forecast["turnoverrate60",], start = c(2017, 5), frequency = 12)
...
deductprofit.simple.rate.forecast <- ts(result.factor.forecast["deductprofit.simple.rate",], start = c(2017, 5), frequency = 12)
...
momentum.12month.forecast <- ts(result.factor.forecast["momentum.12month",], start = c(2017, 5), frequency = 12)
...
momentum.3month.forecast <- ts(result.factor.forecast["momentum.3month",], start = c(2017, 5), frequency = 12)
...
val.lnmv.forecast <- ts(result.factor.forecast["val.lnmv",], start = c(2017, 5), frequency = 12)
...
dividendyield.forecast <- ts(result.factor.forecast["dividendyield",], start = c(2017, 5), frequency = 12)
...
holder.sumpcttop5.forecast <- ts(result.factor.forecast["holder.sumpcttop5",], start = c(2017, 5), frequency = 12)
...
rating.avg.forecast <- ts(result.factor.forecast["rating.avg",], start = c(2017, 5), frequency = 12)
...
roe.forecast <- ts(result.factor.forecast["roe",], start = c(2017, 5), frequency = 12)
...
risk.variance60.forecast <- ts(result.factor.forecast["risk.variance60",], start = c(2017, 5), frequency = 12)
