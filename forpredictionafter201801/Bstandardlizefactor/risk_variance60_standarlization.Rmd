...
monthly.risk.variance60 <- 
        read.csv("D:\\MyR\\quantprog\\forallAstock\\AcollectdataafterJan2018\\monthly.risk.variance60.csv", 
...
processed.monthly.risk.variance60 <- t(monthly.risk.variance60[,-1])
...
risk.variance60.row.names <- colnames(monthly.risk.variance60)[-1]
