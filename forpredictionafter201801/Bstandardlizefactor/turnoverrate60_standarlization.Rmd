...
monthly.tech.turnoverrate60 <- 
        read.csv("D:\\MyR\\quantprog\\forallAstock\\AcollectdataafterJan2018\\monthly.tech.turnoverrate60.csv", 
...
processed.monthly.tech.turnoverrate60 <- t(monthly.tech.turnoverrate60[,-1])
...
turnoverrate60.data.row.names <- colnames(monthly.tech.turnoverrate60)[-1]
...
```{r}
processed.monthly.tech.turnoverrate60 <- 
        processed.monthly.tech.turnoverrate60[,colnames(processed.monthly.tech.turnoverrate60) %in% stockcode]
```
