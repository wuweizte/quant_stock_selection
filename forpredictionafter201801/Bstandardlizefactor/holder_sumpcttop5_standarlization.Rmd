...
monthly.holder.sumpcttop5 <-
        read.csv("D:\\MyR\\quantprog\\forpredictionafter201801\\BAcleandataforNAindustry\\processed.monthly.holder.sumpcttop5.csv",
...
processed.monthly.holder.sumpcttop5 <- t(monthly.holder.sumpcttop5[,-1])
...
holder.sumpcttop5.row.names <- colnames(monthly.holder.sumpcttop5)[-1]
