...
monthly.dividendyield <- 
        read.csv("D:\\MyR\\quantprog\\forallAstock\\AcollectdataafterJan2018\\monthly.dividendyield.csv", 
...
```{r}
processed.monthly.dividendyield <- 
        processed.monthly.dividendyield[row.names(processed.monthly.dividendyield) %in% stockcode,]
