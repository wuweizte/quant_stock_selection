---
title: "roe_factor_efficiency_test"
author: "Wu Wei"
date: "2018-1-25"
...
standardlized.monthly.roe.data <- read.csv("standardlized.monthly.roe.data.csv", stringsAsFactors = FALSE)
...
# for(i in 1:1){
        ...
        ind.dum <- cbind(ind.dum, standardlized.monthly.roe.data[,(i + 1)])
