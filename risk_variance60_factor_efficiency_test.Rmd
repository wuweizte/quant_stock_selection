---
title: "risk_variance60_factor_efficiency_test"
author: "Wu Wei"
date: "2018-1-25"
...
standardlized.monthly.risk.variance60 <- read.csv("standardlized.monthly.risk.variance60.csv", stringsAsFactors = FALSE)
...
# for(i in 1:1){
        ...
        ind.dum <- cbind(ind.dum, standardlized.monthly.risk.variance60[,(i + 1)])
